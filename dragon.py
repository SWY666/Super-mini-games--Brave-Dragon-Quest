...
MOVE = ('./素材/飞龙2.png','./素材/飞龙.png','./素材/飞龙3.png')
MOVERAGE = ('./素材/飞龙怒.png', './素材/飞龙怒2.png','./素材/飞龙怒0.png')
...
class Dragon():
    ...
    def move(self):
        ...
        if self.time%10 == 0:
            self.moveorder+=1
            if self.moveorder == len(self.MOVES):
                self.moveorder = 0
            self.cache = pygame.image.load(self.MOVES[self.moveorder]).convert()
